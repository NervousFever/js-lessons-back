...
ver 6.0.0 change cng-node-js-utils new oxios

ver 4.0.9 change table_name length for 100 

ver 4.0.8 fix return in db.drop(tableName)

ver 4.0.7 add drop() in Model and dropTable(table_name) in DAO

ver 4.0.6 add runAnySql for executeAnyFunction() in Oracle

ver 4.0.5 fix runAnySql for Oracle and Sqlite3

ver 4.0.4 fix Oracle function __$ for $gte, $lte...

ver 4.0.3 fix Oracle-Dao for this.isGte12c

ver 4.0.2 fix convertJson2Params2Sql

ver 4.0.1 add convert sqlWhere for query after ?wheres={} same post but not quost mark

ver 4.0.0 add $or/$and paging for oracle <11 

ver 3.2.3 add name in define tables of models

ver 3.2.2 fix excepted type in structure

ver 3.2.1 add config with index
