/**
 * 4.7 Bổ sung hàm drop(tableName)
 * 
...
// chuyển đổi tổng quát mệnh đề where select count
...
class NodeDatabase {
    ...
    switch (this.cfg.type) {
      ...
      case "oracle":
        ...
        this.db = new OracleDAO(
          ...
          connCfg.isDebug,
          connCfg.auto_increment_support // có hỗ trợ tạo index tức 12c, nếu ko thì là 11
        );
        break;
      case "mongodb":
  ...
  selectCount(tableName, jsonWhere = {}) {
    ...
    if (this.db instanceof MongoDAO) {
      ...
      let sqlWheres = mongoJsonWhere2Sql(jsonWhere);
      // console.log("where?", sqlWheres);
      return this.db
